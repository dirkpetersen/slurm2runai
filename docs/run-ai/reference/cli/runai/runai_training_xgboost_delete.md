...
delete a xgboost training workload
...
runai training xgboost delete <workload-name>

# Delete a workload with a specific project
runai training xgboost delete <workload-name> -p <project-name>

# Delete a workload by UUID
runai training xgboost delete --uuid=<workload-id> -p <project-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_xgboost_delete.md?ask=<question>
```
