...
attach to a running container in a tf training workload
...
runai training tf attach <workload-name> --tty --stdin

# Attaching to a specific pod of a workload
runai training tf attach <workload-name> --pod <pod-name> --tty --stdin
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_tensorflow_attach.md?ask=<question>
```
