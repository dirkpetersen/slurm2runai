...
runai training xgboost resume <xgboost-name> -p <project-name>
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_xgboost_resume.md?ask=<question>
```
