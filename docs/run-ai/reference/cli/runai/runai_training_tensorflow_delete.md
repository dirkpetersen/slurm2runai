...
runai training tf delete <workload-name>

# Delete a workload with a specific project
runai training tf delete <workload-name> -p <project-name>

# Delete a workload by UUID
runai training tf delete --uuid=<workload-id> -p <project-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_tensorflow_delete.md?ask=<question>
```
