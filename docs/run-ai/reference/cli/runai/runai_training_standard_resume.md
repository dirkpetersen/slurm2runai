# runai training standard resume
...
runai training standard resume <standard-name> -p <project-name>
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_standard_resume.md?ask=<question>
```
