...
```
runai inference standard delete [WORKLOAD_NAME] [flags]
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai-inference-standard-delete.md?ask=<question>
```
