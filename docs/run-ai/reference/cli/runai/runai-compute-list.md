...
list compute resource assets

```
runai compute list [flags]
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai-compute-list.md?ask=<question>
```
