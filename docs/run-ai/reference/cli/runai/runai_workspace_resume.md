...
runai workspace resume <workspace-name> -p <project-name>
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_workspace_resume.md?ask=<question>
```
