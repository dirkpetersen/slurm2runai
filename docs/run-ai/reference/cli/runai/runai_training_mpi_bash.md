...
open a bash shell in a mpi training workload
...
runai training mpi bash <workload-name>

# Open a bash shell in a specific worker of the workload
runai training mpi bash <workload-name> --pod <pod-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_mpi_bash.md?ask=<question>
```
