...
runai training tf resume <tf-name> -p <project-name>
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_tensorflow_resume.md?ask=<question>
```
