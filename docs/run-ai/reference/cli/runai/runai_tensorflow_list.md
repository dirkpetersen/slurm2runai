# runai tensorflow list

list tf training workloads
...
runai training tf list -p <project-name>

# List all workloads with a specific output format
runai training tf list --yaml
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_tensorflow_list.md?ask=<question>
```
