...
delete a mpi training workload
...
runai training mpi delete <workload-name>

# Delete a workload with a specific project
runai training mpi delete <workload-name> -p <project-name>

# Delete a workload by UUID
runai training mpi delete --uuid=<workload-id> -p <project-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_mpi_delete.md?ask=<question>
```
