...
runai training mpi list -p <project-name>

# List all workloads with a specific output format
runai training mpi list --yaml
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_mpi_list.md?ask=<question>
```
