...
```
runai inference standard exec [WORKLOAD_NAME] [flags]
```
...
runai inference exec <workload-name> --pod <pod-name> -- nvidia-smi
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai-inference-standard-exec.md?ask=<question>
```
