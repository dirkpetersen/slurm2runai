# runai training jax attach

attach to a running container in a jax training workload

```
runai training jax attach [WORKLOAD_NAME] [flags]
```
...
runai training jax attach <workload-name> --tty --stdin

# Attaching to a specific pod of a workload
runai training jax attach <workload-name> --pod <pod-name> --tty --stdin
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_jax_attach.md?ask=<question>
```
