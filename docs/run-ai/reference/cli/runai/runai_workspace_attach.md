...
attach to a running container in a workspace workload
...
runai workspace attach <workload-name> --tty --stdin

# Attaching to a specific pod of a workload
runai workspace attach <workload-name> --pod <pod-name> --tty --stdin
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_workspace_attach.md?ask=<question>
```
