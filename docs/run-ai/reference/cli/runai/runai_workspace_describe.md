...
runai workspace describe <workload-name>

# Describe a workload in a specific project
runai workspace describe <workload-name> -p <project-name>

# Describe a workload by UUID
runai workspace describe --uuid=<workload-id>

# Describe a workload with specific output format
runai workspace describe <workload-name> -o json

# Describe a workload with specific sections
runai workspace describe <workload-name> --general --compute --pods --events --networks

# Describe a workload with container details and custom limits
runai workspace describe <workload-name> --containers --pod-limit 20 --event-limit 100
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_workspace_describe.md?ask=<question>
```
