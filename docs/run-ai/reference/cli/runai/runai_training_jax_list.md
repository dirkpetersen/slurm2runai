# runai training jax list

list jax training workloads

```
runai training jax list [flags]
```

## Examples

```
# List all jax training workloads
runai training jax list -A

# List workloads with default project
runai training jax list

# List workloads in a specific project
runai training jax list -p <project-name>

# List all workloads with a specific output format
runai training jax list --yaml

# List workloads with pagination
runai training jax list --limit 20 --offset 40
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_jax_list.md?ask=<question>
```
