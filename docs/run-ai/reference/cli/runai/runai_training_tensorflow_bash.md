# runai training tensorflow bash

open a bash shell in a tf training workload
...
runai training tf bash <workload-name>

# Open a bash shell in a specific worker of the workload
runai training tf bash <workload-name> --pod <pod-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_tensorflow_bash.md?ask=<question>
```
