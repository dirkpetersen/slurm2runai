...
```
runai inference standard logs [WORKLOAD_NAME] [flags]
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai-inference-standard-logs.md?ask=<question>
```
