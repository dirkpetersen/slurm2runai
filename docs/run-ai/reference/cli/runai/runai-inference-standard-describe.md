# runai inference standard describe

describe an inference workload

```
runai inference standard describe [WORKLOAD_NAME] [flags]
```
...
runai inference describe <workload-name>

# Describe a workload in a specific project
runai inference describe <workload-name> -p <project-name>

# Describe a workload by UUID
runai inference describe --uuid=<workload-id>

# Describe a workload with specific output format
runai inference describe <workload-name> -o json

# Describe a workload with specific sections
runai inference describe <workload-name> --general --compute --pods --events --networks

# Describe a workload with container details and custom limits
runai inference describe <workload-name> --containers --pod-limit 20 --event-limit 100
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai-inference-standard-describe.md?ask=<question>
```
