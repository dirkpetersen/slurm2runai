...
runai training xgboost list -p <project-name>
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_xgboost_list.md?ask=<question>
```
