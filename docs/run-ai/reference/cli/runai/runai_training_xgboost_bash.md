# runai training xgboost bash

open a bash shell in a xgboost training workload
...
runai training xgboost bash <workload-name>

# Open a bash shell in a specific worker of the workload
runai training xgboost bash <workload-name> --pod <pod-name>
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_xgboost_bash.md?ask=<question>
```
