# runai training jax describe

describe a jax training workload

```
runai training jax describe [WORKLOAD_NAME] [flags]
```
...
runai training jax describe <workload-name>

# Describe a workload in a specific project
runai training jax describe <workload-name> -p <project-name>

# Describe a workload by UUID
runai training jax describe --uuid=<workload-id>

# Describe a workload with specific output format
runai training jax describe <workload-name> -o json

# Describe a workload with specific sections
runai training jax describe <workload-name> --general --compute --pods --events --networks

# Describe a workload with container details and custom limits
runai training jax describe <workload-name> --containers --pod-limit 20 --event-limit 100
```
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/reference/cli/runai/runai_training_jax_describe.md?ask=<question>
```
