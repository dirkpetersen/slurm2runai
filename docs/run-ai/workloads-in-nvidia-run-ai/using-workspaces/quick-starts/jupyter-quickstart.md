...
A workspace contains the setup and configuration needed for building your model, including the container, images, data sets, and resource requests, as well as the required tools for the research, all in one place. See [Running workspaces](/self-hosted/workloads-in-nvidia-run-ai/using-workspaces/running-workspace.md) for more information.
...
9. Under **Compute resources**, click the **load** icon. A side pane appears, displaying a list of available compute resources. Select the **‘one-gpu’** compute resource for your workload.
...
9. Select the **‘one-gpu’** compute resource for your workspace
...
```
GET https://run-ai-docs.nvidia.com/self-hosted/workloads-in-nvidia-run-ai/using-workspaces/quick-starts/jupyter-quickstart.md?ask=<question>
```
